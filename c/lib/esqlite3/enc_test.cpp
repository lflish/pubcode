...
#define select_encrypt "select * from encrypt;"
...
void test_exec_v2()
{
	...
	esqlite *db = esqlite_open("passwd.db", SQLITE_OPEN_READWRITE|SQLITE_OPEN_CREATE|SQLITE_OPEN_FULLMUTEX, "8wuL(<+AI7%BZ.%B");
	assert(db != NULL);
